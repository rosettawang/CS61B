...
public class Tester {
    ...
    public void maxTest() {
        ...
        assertEquals(14, HW0Solutions.max(new int[]{0, -5, 2, 14, 10}));
        // REPLACE THIS WITH MORE TESTS.
        assertEquals(0, HW0Solutions.max(new int[]{0}));
    }

    @Test
    public void threeSumTest() {
        // Change call to threeSum to make this call yours.
        assertTrue(HW0Solutions.threeSum(new int[]{-6, 3, 10, 200}));
        // REPLACE THIS WITH MORE TESTS.
        assertTrue(HW0Solutions.threeSum(new int[]{8, -4}));
    }

    @Test
    public void threeSumDistinctTest() {
        // Change call to threeSumDistinct to make this call yours.
        assertFalse(HW0Solutions.threeSumDistinct(new int[]{-6, 3, 10, 200}));
        // REPLACE THIS WITH MORE TESTS.
        assertTrue(HW0Solutions.threeSumDistinct(new int[]{-6, 3, 3, 200}));
    }
